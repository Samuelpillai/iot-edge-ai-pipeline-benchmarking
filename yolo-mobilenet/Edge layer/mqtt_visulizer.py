...
def start_mqtt_listener():
    ...
    client.subscribe("inference/logsOfSecP")
    client.loop_forever()
...
fig.suptitle("Edge Inference Metrics Dashboard", fontsize=16)
fig.canvas.manager.set_window_title("Pipeline Two - Inference Dashboard")
